    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <div class="logo-wrapper">
                <a class="logo" href="o_index.html"> <img src="img/logo.png" class="logo-img" alt=""> </a>
                <!-- <a class="logo" href="o_index.html"> <h2>THE CAPPA <span>Luxury Hotel</span></h2> </a> -->
            </div>
            <!-- Button -->
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Home <i class="ti-angle-down"></i></a>
                        <ul class="dropdown-menu">
                            <li><a href="o_index.html" class="dropdown-item"><span>Home Layout 1</span></a></li>
                            ...
                            <li><a href="index.html" class="dropdown-item"><span>Slideshow 1</span></a></li>
                    ...
                    <li class="nav-item"><a class="nav-link active" href="spa-wellness.html">Spa</a></li>
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">News <i class="ti-angle-down"></i></a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="blog.html" class="dropdown-item"><span>News 2</span></a></li>
                            <li><a href="blog_detail.html" class="dropdown-item"><span>Post Page</span></a></li>
                        </ul>
                    </li>
    ...
    <section class="services section-padding2">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 p-0 animate-box" data-animate-effect="fadeInLeft">
                    <div class="img left">
                        <a href="blog_detail.html"><img src="img/spa/1.jpg" alt=""></a>
                    </div>
                </div>
                <div class="col-md-6 p-0 bg-cream valign animate-box" data-animate-effect="fadeInRight">
                    <div class="content">
