                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Rooms & Suites <i class="ti-angle-down"></i></a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="rooms.html" class="dropdown-item"><span>Rooms 2</span></a></li>
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="item">
                                <div class="post-img">
                                    <a href="blog_detail.html"> <img src="img/restaurant/2.jpg" alt=""> </a>
                                    <div class="date">
                                ...
                                <div class="post-cont"> 
                                   <a href="news.html"><span class="tag">Restaurant</span></a>
                                    ...
                                    <div class="butn-dark"> <a href="blog_detail.html"><span>Read More</span></a> </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="item">
                                <div class="post-img">
                                    <a href="blog_detail.html"> <img src="img/spa/3.jpg" alt=""> </a>
                                    <div class="date">
                        ...
                        <div class="col-md-12">
                            <div class="item">
                                <div class="post-img">
                                    <a href="blog_detail.html"> <img src="img/slider/7.jpg" alt=""> </a>
                                    <div class="date">
                                ...
                                <div class="post-cont">
                                   <a href="news.html"><span class="tag">Hotel Design</span></a>
                                    <h5><a href="blog_detail.html">Retro Lighting Design in The Hotels</a></h5>
                                    <p>Hotel potenti fringilla pretium ipsum non blandit. Vivamus eget nisi non mi iaculis iaculis imperie quiseros sevin elentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis enesta mauris suscipit mis nec est aliquam, a tincidunt eros iacu suscipit risus eu ullamcorper fauibu.</p>
                                    <div class="butn-dark"> <a href="blog_detail.html"><span>Read More</span></a> </div>
                                </div>
                            </div>
                    ...
                    <div class="news2-sidebar row">
                        ...
                        <div class="col-md-12">
                            <div class="widget">
                                ...
                                <ul class="recent">
                                    <li>
                                        <div class="thum"> <img src="img/restaurant/2.jpg" alt=""> </div> 
                                        <a href="blog_detail.html">Historic restaurant renovated</a>
                                    </li>
                                    <li>
                                        <div class="thum"> <img src="img/spa/3.jpg" alt=""> </div> 
                                        <a href="blog_detail.html">Benefits of Spa Treatments</a>
                                    </li>
                                    <li>
                                        <div class="thum"> <img src="img/slider/7.jpg" alt=""> </div> 
                                        <a href="blog_detail.html">Retro Lighting Design in The Hotels</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="footer-column footer-about">
                            ...
                            <p class="footer-about-text">The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</p>
                    ...
                    <div class="col-md-4">
                        <div class="footer-column footer-contact">
                            ...
                            <p class="footer-contact-text">Address<br>Rajasthan</p>
                            <div class="footer-contact-info">
                                <p class="footer-contact-phone"><span class="flaticon-call"></span>+9876543211</p>
                                <p class="footer-contact-mail">email here</p>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="footer-bottom-inner">
                            <p class="footer-bottom-copy-right">© Copyright 2022 by <a href="#">#</a></p>
                        </div>
                    </div>
                </div>
            </div>
