...
?>
    <!-- Restaurant Slider -->
        ...
        <div class="banner-header section-padding valign bg-img bg-fixed" data-overlay-dark="4" data-background="img/index/r1.webp"  >
                <div class="container">
                    <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-left"> 
                    ...
                    <div class="section-title">The Haveli Delight</div>
                </div>
                <div class="col-md-12">
                    <p class="mb-30">At Haveli Delight, we invite you to discover a special place where delicious food meets a cozy atmosphere. Our restaurant is all about tasty meals made from wonderful recipes passed down through generations. You'll find a menu full of yummy dishes inspired by different regions, each cooked with care and the best ingredients. Step inside and feel the warmth of our welcoming space, decorated with beautiful things that make it feel like home. Whether it's a small gathering or a big celebration, our friendly staff is here to make your dining experience unforgettable. Come, join us, and enjoy the taste of tradition at Haveli Delight!</p>
                    <h6>Hours</h6>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="section-subtitle"><span>Heritage Hotel</span></div>
