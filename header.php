    ...
    <aside class="kenburns-section" id="kenburnsSliderContainer" data-overlay-dark="3">
        <div class="kenburns-inner h-100">
            <div class="v-middle caption text-center">
                <div class="container">
                    <div class="row h-100">
                        <div class="col-md-12">
                            <h4>Welcome to Resort Haveli</h4>
                            <h1>The best  Heritage Resort</h1>
                            <div class="butn-light mt-30 mb-30"> <a href="rooms.php" data-scroll-nav="2"><span>Rooms &amp; Suites</span></a> </div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="reservation">
            <a href="tel:8551004444">
                ...
                <div class="call"><span style="color: white">+91 99281 12220</span>
                    <br>Reservation
                </div>
            </a>
        </div>
