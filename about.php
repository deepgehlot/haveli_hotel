        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-30 animate-box" data-animate-effect="fadeInUp"> 
                    ...
                    <div class="section-title">Enjoy a Heritage Experience</div>
...
<!--                    <p>Hotel ut nisl quam nestibulum ac quam nec odio elementum sceisue the aucan ligula. Orci varius natoque penatibus et magnis dis parturient monte nascete ridiculus mus nellentesque habitant morbine.</p>-->
                ...
                <div class="col col-md-3 animate-box" data-animate-effect="fadeInUp"> <img src="img/index/about1.JPG" alt="" class="mt-90 mb-30"> </div>
                <div class="col col-md-3 animate-box" data-animate-effect="fadeInUp"> <img src="img/index/about_main.JPG" alt=""> </div>
            </div>
        </div>
    </section>
    <!-- Pricing -->
